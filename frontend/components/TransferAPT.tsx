  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="space-y-2">
        <h4 className="text-lg font-medium">Account Balances</h4>
        <p className="text-sm">APT balance: {aptBalance / Math.pow(10, 8)} APT</p>
        <p className="text-sm">USDC balance: {usdcBalance / Math.pow(10, 6)} USDC</p>
      </div>
      <div className="space-y-4">
        <h5 className="text-md font-medium">Transfer APT</h5>
